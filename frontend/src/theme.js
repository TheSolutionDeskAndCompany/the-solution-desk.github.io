  ...
  components: {
    Button: {
      ...
      variants: {
        ...
        outline: (props) => ({
          borderColor: props.colorMode === 'dark' ? 'neonBlue.500' : 'brand.500',
    ...
    Input: {
      variants: {
        outline: (props) => ({
          field: {
            borderColor: props.colorMode === 'dark' ? 'neonBlue.500' : 'gray.300',
            bg: props.colorMode === 'dark' ? 'darkBg.200' : 'white',
            color: props.colorMode === 'dark' ? 'neonPink.200' : 'gray.800',
            _hover: {
              borderColor: props.colorMode === 'dark' ? 'neonBlue.400' : 'brand.400',
            },
            _focus: {
              borderColor: props.colorMode === 'dark' ? 'neonPink.500' : 'brand.500',
